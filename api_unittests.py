...
class TestApi(unittest.TestCase):
	def setUp(self):
		...
		self.addr3 = Address(street_number=1234, street_name="test street", street_type = "st", city_name = "Palo Alto", zipcode=98505, district="CA")
	...
	def test_add_address(self):
		...
		speranza_api.add_address(request)
		assert(len(Address.query.filter(Address.street_type == "St").all()) == 1), len(Address.query.filter(Address.street_type == "St").all())

...
class TestModels(unittest.TestCase):
	...
	def test_address(self):
		full_address = Address(street_number=1234, street_name="test street", street_type = "st", city_name = "Palo Alto", zipcode=98505, district="CA")
	...
	def test_patient(self):
		...
		assert(patient.grant_access(1000) == False)
		assert(patient.grant_access(pt_org.id) == True)
	...
	def test_manager(self):
		...
		assert(fetch_mgr.verify_password("pass") == True)
	...
	def test_org(self):
		...
		admin1 = Manager(firstname = "admin", lastname = "wan", phone_number = 12345, password= "pass", email="test_email@email.com")
		admin2 = Manager(firstname = "admin", lastname = "two", phone_number = 12345, password= "pass", email="test_email@email.com")
